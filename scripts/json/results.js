results = {
  ...
  "4theory": {
    ...
    result_zhCN: "你是第四理论者",
    desc_zhCN:
      "“第四种理论”是由俄罗斯政治分析家亚历山大-杜金构思的意识形态，试图在自由主义、马克思主义和法西斯主义之后找到一种新的政治理论。",
  },
  agorism: {
...
result_zhCN: "你是一个农业社会主义者",
  ...
  ancol: {
    result_en: "You're an Anarcho-Collectivist", // Result 5
    desc_en:
    ...
    result_zhCN: "你是一个无政府集体主义者",
    desc_zhCN:
      "无政府集体主义试图建立一个无国家的社会，由工人拥有生产资料，用商品交换代表劳动的“劳动证明”。",
  },
  ancom: {
    result_en: "You're an Anarcho-Communist", // Result 6
    desc_en:
    ...
    result_zhCN: "你是一个无政府共产主义者",
    desc_zhCN:
      "无政府共产主义旨在建立一个基于互助经济的无国家、无阶级、无金钱的社会。",
  },
  angeo: {
  ...
  anprim: {
    ...
    result_zhCN: "你是无政府原始主义者",
    desc_zhCN:
      "无政府原始主义是一种主张回归前文明生活的意识形态。它的独特之处在于反对农业文明和工业文明，希望采取狩猎-采集的生活方式。",
  },
  ansynd: {
    result_en: "You're an Anarcho-Syndicalist", // Result 9
    desc_en:
    ...
    result_zhCN: "你是无政府工团主义者",
    desc_zhCN:
      "无政府工团主义旨在利用工人运动的力量建立一个生产资料归工人所有的后资本主义无国家社会。",
  },
  bhl: {
    result_en: "You're a Bleeding-Heart Libertarian", // Result 10
    desc_en:
    ...
    result_zhCN: "你是古典自由主义者",
    desc_zhCN: "古典自由主义认为，扩大公民自由将对弱势群体有利。",
  },
  bordiga: {
    result_en: "You're a Bordigist/Italian Left-Communist", // Result 11
    desc_en:
      "Italian Left Communism is an ideology that takes a staunchly anti-revisionist approach to Marx and Lenin's works, being extremely critical of their sucessors' developments", // todo
    result_zhCN: "你是博迪格派/意大利左翼共产主义者",
    desc_zhCN:
      "意大利左翼共产主义对马克思和列宁的作品采取坚定的反修正主义态度，对他们继任者的发展进行强烈否认。",
  },
  castro: {
    result_en: "You're a Castroist", // Result 12
    desc_en:
    ...
    result_zhCN: "你是卡斯特罗主义者",
    desc_zhCN:
      "卡斯特罗主义是菲德尔-卡斯特罗将马克思列宁主义应用于古巴而产生的一种意识形态，主要是在先锋队的作用方面有所不同。",
  },
  fascism: {
    result_en: "You're a Classical Fascist", // Result 13
    desc_en:
      "Fascism is a form of far-right, authoritarian ultranationalism characterized by dictatorial power, forcible suppression of opposition and strong regimentation of society and of the economy", // cp
    result_zhCN: "你是古典法西斯主义者",
    desc_zhCN:
      "法西斯主义是一种极右的、专制的极端民族主义，其特点是使用极权强力镇压反对派，对社会和经济进行全面而强硬的管理。",
  },
  clerfash: {
    result_en: "You're a Clerical Fascist", // Result 14
    desc_en:
      "Clerical fascism is an ideology that combines the political and economic doctrines of fascism with clericalism", // cp
    result_zhCN: "你是教权法西斯主义者",
    desc_zhCN:
      "教权法西斯主义是一种将法西斯主义的政治和经济学说与教权主义相结合的意识形态。",
  },
  councom: {
    result_en: "You're a Council Communist", // Result 15
    desc_en:
    ...
    result_zhCN: "你是议会共产主义者",
    desc_zhCN: "议会共产主义认为，成功的社会主义社会应当由工人议会来运行",
  },
  deleon: {
    result_en: "You're a De Leonist", // Result 16
    desc_en:
    ...
    result_zhCN: "你是德·莱昂主义者",
    desc_zhCN:
      "德·莱昂主义是一种将工团主义组织与无产阶级专政概念等马克思主义思想相结合的意识形态。",
  },
  demsoc: {
    result_en: "You're a Democatic Socialist", // Result 17
    desc_en:
    ...
    result_zhCN: "你是民主社会主义者",
    desc_zhCN: "民主社会主义试图通过选举程序和改革，而非革命手段建立社会主义。",
  },
  deng: {
    result_en: "You're a Dengist/Socialist with Chinese Characteristics", // Result 18
    desc_en:
    ...
    result_zhCN: "你是邓小平主义者 / 中国特色社会主义者",
    desc_zhCN:
      "中国特色社会主义声称，在进入完全的社会主义之前，应当经历一段长期的国家资本主义时期",
  },
  distributism: {
    result_en: "You're a Distributist", // Result 19
    desc_en: "Distributism is a third-way, free market, center-right ideology", // cp
    result_zhCN: "你是分产主义者",
    desc_zhCN: "分产主义是一种第三路线、主张自由市场的中右翼意识形态",
  },
  geolib: {
    result_en: "You're a Geolibertarian", // Result 20
    desc_en:
    ...
    result_zhCN: "你是乔治自由意志主义者",
    desc_zhCN:
      "乔治自由意志主义是一种意识形态，它将自由贸易、自由土地和价值税等乔治主义原则与自由主义的最小政府原则结合起来。",
  },
  georgism: {
    result_en: "You're a Georgist", // Result 21
    desc_en:
    ...
    result_zhCN: "你是乔治主义者",
    desc_zhCN:
      "乔治主义认为，要想有一个真正的自由市场，首先必须打破对土地的垄断。它主张征收土地价值税，致力于使土地所有权失去意义。",
  },
  leftroth: {
    result_en: "You're a Left-Rothbardian", // Result 22
    desc_en:
    ...
    result_zhCN: "你是左翼罗斯巴德主义者",
    desc_zhCN:
      "左翼罗斯巴德主义是对传统的罗斯巴德无政府资本主义的一种左翼思考，认为无政府资本主义社会是实现社会和经济平等等传统左翼目标的理想环境。",
  },
  libert: {
    result_en: "You're a Right-Libertarian", // Result 23
    desc_en:
    ...
    result_zhCN: "你是右翼自由意志主义者",
    desc_zhCN:
      "右翼自由意志主义是一种支持资本主义产权的意识形态，它捍卫自然资源和私有财产的市场分配。",
  },
  libsoc: {
    result_en: "You're a Libertarian Socialist", // Result 24
    desc_en:
    ...
    result_zhCN: "你是自由意志社会主义者",
    desc_zhCN:
      "自由意志社会主义认为，生产资料应该由工人拥有和管理。国家对经济几乎不进行干预，这与采取国有制的社会主义流派形成对比。",
  },
  lib: {
    result_en: "You're a Keynesian Liberal", // Result 25
    desc_en:
    ...
    result_zhCN: "你是凯恩斯主义 / 社会自由主义者",
    desc_zhCN:
      "凯恩斯主义是自由资本主义的一种形式，它认为市场必须在干预主义国家的监督下才能充分运作。",
  },
  luxem: {
    result_en: "You're a Luxemburgist", // Result 26
    desc_en:
      "Luxemburgism is a Marxist-Communist, Libertarian, anti-war, and extremely progressive ideology that believes that the Dictatorship of the Proletariat should be run by democratic workers councils and unions, rather than a Socialist Party.", // cp
    result_zhCN: "你是卢森堡主义者",
    desc_zhCN:
      "卢森堡主义是一种马克思主义-共产主义、自由主义、反战的激进意识形态，认为无产阶级专政应该由民主的工人委员会和工会来管理，而不是由先锋队（党）来管理。",
  },
  lwma: {
    result_en: "You're a Left-Wing Market Anarchist", // Result 27
    desc_en:
    ...
    result_zhCN: "你是左翼市场无政府主义者",
    desc_zhCN:
      "左翼市场无政府主义旨在建立一个基于后资本主义市场经济的无国家社会。",
  },
  mao: {
    result_en: "You're a Maoist", // Result 28
    desc_en:
      "Maoism is a variety of Marxism–Leninism that Mao Zedong developed for realising a socialist revolution in the agricultural, pre-industrial society of China. The main difference being is that the peasantry are the revolutionary vanguard in pre-industrial societies rather than the proletariat.", // cp
    result_zhCN: "你是毛泽东主义者",
    desc_zhCN:
      "毛泽东主义是毛泽东为了在中国的前工业社会实现社会主义革命而发展的马克思列宁主义分支。它的主要区别在于，以农民而非工人作为前工业社会的革命先锋。",
  },
  marksoc: {
    result_en: "You're a Market Socialist", // Result 29
    desc_en:
    ...
    result_zhCN: "你是市场社会主义者",
    desc_zhCN:
      "市场社会主义将工人拥有生产资料的社会主义理想与市场经济提供的竞争和资源分配相结合。",
  },
  minarch: {
    result_en: "You're a Minarchist", // Result 30
    desc_en:
    ...
    result_zhCN: "你是最小政府主义者",
    desc_zhCN:
      "最小政府主义认为，国家的唯一职能是保护公民的财产权、惩处罪犯，并保卫国家的领土不受任何入侵。",
  },
  mlm: {
    result_en: "You're a Marxist–Leninist–Maoist", // Result 31
    desc_en:
    ...
    result_zhCN: "你是马-列-毛主义者",
    desc_zhCN:
      "马-列-毛主义是秘鲁共产党定义的一种意识形态，它综合了马列主义和毛泽东主义的思想，但否认了后者的某些方面，如三个世界理论。",
  },
  ml: {
    result_en: "You're a Marxist–Leninist", // Result 32
    desc_en:
    ...
    result_zhCN: "你是马列主义者（尤指斯派——译者注）",
    desc_zhCN:
      "与托洛茨基主义的不断革命论不同，马克思列宁主义（尤指斯派——译者注）认为，在向邻国输出革命之前，有必要在一个国家建立和发展社会主义。",
  },
  mutualism: {
    result_en: "You're a Mutualist", // Result 33
    desc_en:
    ...
    result_zhCN: "你是互助主义者",
    desc_zhCN:
      "互助主义是一种意识形态，它寻求建立一个无国家的社会，其基础是个人之间的商品自由贸易，以及一个相互的信贷银行和互助结构。",
  },
  natan: {
    result_en: "You're a National Anarchist", // Result 34
    desc_en:
    ...
    result_zhCN: "你是无政府民族主义者",
    desc_zhCN:
      "无政府民族主义旨在建立一个由民族社区组成的无国家社会，其基础是任人唯贤的互助主义经济体系。",
  },
  natsynd: {
    result_en: "You're a National Syndicalist", // Result 35
    desc_en:
      "National syndicalism is an adaptation of syndicalism to suit the social agenda of integral nationalism.",
    result_zhCN: "你是国家工团主义者",
    desc_zhCN: "国家工团主义是对工团主义的调整，以适应当时民族主义的社会趋势。",
  },
  nazbol: {
    result_en: "You're a National Bolshevik", // Result 36
    desc_en:
      "National Bolshevism is a political movement that combines elements of fascism and Bolshevism",
    result_zhCN: "你是民族布尔什维克",
    desc_zhCN:
      "民族布尔什维克是一个结合了法西斯主义和布尔什维克主义的意识形态。",
  },
  nazcap: {
    result_en: "You're a National Capitalist", // Result 37
    desc_en:
      "National Capitalism is an economically right wing, culturally traditionalist, nationalist and fascist ideology",
    result_zhCN: "你是国家资本主义者",
    desc_zhCN:
      "国家资本主义是一种经济上的右翼、文化上的传统主义、民族主义和法西斯主义的意识形态。",
  },
  nazi: {
    result_en: "You're a National Socialist", // Result 38
    desc_en:
    ...
    result_zhCN: "你是国家社会主义者",
    desc_zhCN:
      "国家社会主义是法西斯主义的一种形式，它对自由民主和议会制度嗤之以鼻。它将狂热的反犹太主义、反共产主义、科学种族主义和使用优生学纳入其信条。",
  },
  neocon: {
    result_en: "You're a Neoconservative", // Result 39
    desc_en:
    ...
    result_zhCN: "你是新保守主义者",
    desc_zhCN:
      "新保守主义在国际事务中提倡民主和干涉主义，包括通过实力实现和平，并以对共产主义和政治激进主义的蔑视而闻名。",
  },
  neolib: {
    result_en: "You're a Neoliberal", // Result 40
    desc_en:
    ...
    result_zhCN: "你是新自由主义者",
    desc_zhCN:
      "新自由主义是新古典自由主义和凯恩斯主义经济思想的融合，试图在监管和自由放任之间取得平衡。",
  },
  orthmarx: {
    result_en: "You're an Orthodox Marxist", // Result 41
    desc_en:
    ...
    result_zhCN: "你是原教旨马克思主义者",
    desc_zhCN:
      "原教旨马克思主义是一种经济上极左的进步意识形态，期望实现一个共产主义社会，一个无国家、阶级和资本的社会。",
  },
  paleobert: {
    result_en: "You're a Paleolibertarian", // Result 42
    desc_en:
    ...
    result_zhCN: "你是新古典自由主义者",
    desc_zhCN:
      "新古典自由主义是美国无政府资本主义理论家默里·罗斯巴德和卢·洛克威尔提出的一种意识形态，它将传统的保守文化价值观和社会哲学与反对政府干预的自由主义相结合。",
  },
  paleocon: {
    result_en: "You're a Paleoonservative", // Result 43
    desc_en:
    ...
    result_zhCN: "你是新古典保守主义者",
    desc_zhCN:
      "新古典保守主义是保守主义的一种形式，最初表现为美国保守主义中的孤立主义派别，他们反对越南战争。新古典保守主义者通常也反对全球自由贸易，采取非常保护主义的方法，实行强有力的关税。",
  },
  patcon: {
    result_en: "You're a Paternalistic Conservative", // Result 44
    desc_en:
    ...
    result_zhCN: "你是家长制保守主义者",
    desc_zhCN:
      "家长制保守主义是一种意识形态，它试图将有规划的资本主义、强工会的社会民主原则与传统价值观结合起来。",
  },
  posadism: {
    result_en: "You're a Posadist", // Result 45
    desc_en:
    ...
    result_zhCN: "你是波萨达斯主义者",
    desc_zhCN:
      "波萨达斯主义是从托洛茨基主义衍生出来的一种加速主义意识形态。波萨达斯主义认为，想在全球实现社会主义，一场足以摧毁整个资本主义社会的核战争是必要的。（当然，也许还要加上来自外星同志们的帮助）",
  },
  situationist: {
    result_en: "You're a Situationist", // Result 46
    desc_en:
    ...
    result_zhCN: "你是情境主义者",
    desc_zhCN:
      "情境主义是一场前卫的马克思自由主义者的运动，他们主要侧重于通过艺术手段批评资本主义。",
  },
  socbert: {
    result_en: "You're a Social Libertarian", // Result 47
    desc_en:
    ...
    result_zhCN: "你是社会自由主义者",
    desc_zhCN:
      "社会自由主义是自古典自由主义发展而来的。它认为普遍的基本收入，加上最大的个人自由，是为所有人包括社会上最弱势的人实现公平社会的必要条件。",
  },
  socdem: {
    result_en: "You're a Social Democrat", // Result 48
    desc_en:
    ...
    result_zhCN: "你是社会民主主义者",
    desc_zhCN:
      "社会民主主义旨在建立一个资本主义受国家和强工会限制的社会，以实现对工人阶级有利的结果。",
  },
  socgeo: {
    result_en: "You're a Social Georgist", // Result 49
    desc_en:
    ...
    result_zhCN: "你是单税社会主义者",
    desc_zhCN:
      "单税社会主义认为，乔治主义的土地公有制和土地价值税原则是对自由市场福利主义社会的完美补充，这种意识形态最突出的倡导者是中国革命家和中华民国第一任总统孙中山。（指民生主义——译者注）",
  },
  socnat: {
    result_en: "You're a Social Nationalist", // Result 50
    desc_en:
    ...
    result_zhCN: "你是社会民族主义者",
    desc_zhCN:
      "社会民族主义是一种民族主义分支，以民族自决、人民主权和社会平等为纲领",
  },
  statesoc: {
    result_en: "You're a State Socialist", // Result 51
    desc_en:
    ...
    result_zhCN: "你是国有制社会主义者",
    desc_zhCN:
      "国有制社会主义认为，生产资料应当由国家所有、由国家管理，与自由意志社会主义针锋相对",
  },
  strasser: {
    result_en: "You're a Strasserist", // Result 52
    desc_en:
    ...
    result_zhCN: "你是斯特拉瑟主义者",
    desc_zhCN:
      "斯特拉瑟主义是由斯特拉塞兄弟推广的一种意识形态，它将左翼经济与右翼极端主义相融合。",
  },
  synd: {
    result_en: "You're a Syndicalist", // Result 53
    desc_en:
      "Syndicalism is an ideology that seeks to advance the demands and rights of workers through strikes.",
    result_zhCN: "你是工团主义者",
    desc_zhCN: "工团主义旨在通过罢工推进工人的要求和权利。",
  },
  technocracy: {
    result_en: "You're a Technocrat", // Result 54
    desc_en:
    ...
    result_zhCN: "你是技术官僚主义者",
    desc_zhCN:
      "技术官僚主义认为，国家和经济应该由特定领域的专家来管理，而不是由选举 / 继承的政治家和商人来管理。",
  },
  theocracy: {
    result_en: "You're a Theocrat", // Result 55
    desc_en:
    ...
    result_zhCN: "你是神权主义者",
    desc_zhCN:
      "在这种意识形态中，统治者作为神的代表，对公民强制执行其特定宗教的法律。",
  },
  tito: {
    result_en: "You're a Titoist", // Result 56
    desc_en:
    ...
    result_zhCN: "你是铁托主义者",
    desc_zhCN:
      "铁托主义试图将列宁主义的先锋队与市场社会主义经济和工人拥有的生产资料相结合。",
  },
  trot: {
    result_en: "You're a Trotskyist", // Result 57
    desc_en:
    ...
    result_zhCN: "你是托洛茨基主义者",
    desc_zhCN:
      "托洛茨基主义认为，世界革命和不断革命是建立社会主义的必要条件，这与马克思列宁主义（尤指斯派——译者注）的社会主义思想在1个国家形成鲜明对比。",
  },
};
